...
TOKEN=os.environ["FB_PAGE_ACCESS_TOKEN"]; BASE="https://graph.facebook.com/v23.0"
...
def main():
    ...
    me=urllib.request.urlopen(urllib.request.Request(f"{BASE}/me?fields=id,name&access_token={urllib.parse.quote(TOKEN)}")).read(); page=json.loads(me); page_id=page["id"]
    ...
    result=call(f"{page_id}/feed",params); print("Facebook published:",result,"page:",page.get("name"))
